...
<p align="center">
    ...
    <a href="https://tic-tac-toe.cyrilo.app/">:computer: Live Demo :eyes:</a><br/><br/>
</p>
...
#### Principal Features
- Human Player vs. Unbeatable Computer ;
...
```sh
git clone https://github.com/Banaanas/tic-tac-toe-TOP.git
```
...
[https://github.com/Banaanas/tic-tac-toe-TOP](https://github.com/Banaanas/tic-tac-toe-TOP)
